...
date            : 31 Jan 2024 
                ...
                :
title           : cliRqExecProgInAtt_nointeract.py
                :                          
description     : A client that that communicates with a server over
                : a secure channel and thorugh port 9999 of the local
                : host to request the execution of a program. In this
                : example I use hellopidhostname.c, precisely, its
                : executable version.
                : In this version the port number (9999) is hardcoded in the 
                : server and client.
                : 
                : a) This client provides the name of the program
                :    to execute (eg hello, hellopidhostname, etc).
...
notes           :
compile and run : 
                : 1) In a different window execute
                : $ python3 attestablelauncher_nointeract.py
                :
                : 2)
                : $ python3 attestablelaunchernoninteract.py 
