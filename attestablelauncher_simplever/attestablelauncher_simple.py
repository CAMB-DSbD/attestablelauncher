...
date            : 5 Feb 2024 
                :
title           : attestablelauncher_simple.py 
                :
description     : A more refines version of the attestable launcher
                : is located in the main folder and called attestablelauncher.py
                : I'm keeping this the attestablelauncher_simple.py only
                : for conducting some testing.
                : The attestablelauncher_nointeractive.py is also more mature
                : than this version.
                :
                : An attestable launcher that: 
...
notes           :
                ...
                :
compile and run : 
                : bash-3.2$ py attestablelauncher_simple.py
                : An instance of Signmessage has been created
                : Bob's server running... Its PEM pass phrase is: camb
                : Enter PEM pass phrase:
                :
                : To run the attestable launcher.py, place in the current
                : directory "bobServer.key.pem", that is a file with
                : bobServer's private key in PEM format.
                :
                : The key should correspond to the public key included
                : in bobServer's certificate: bobServer.cert.pem
                :
                : Both bobServer.key.pem and bobServer.cert.pem can be
                : generated by python or openssl. I used the latter.
                :
"""
