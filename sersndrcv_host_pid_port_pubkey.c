 ...
 *
 * sersndrcv_host_pid_port_pubkey.c
 * 
 ...
 * of program name, hostname, process id number port number
 * and public key.
 ...
 *
 * compilation: % cc -o ser sersndrcv_host_pid_port_pubkey.c 
 * execution:
 *  
 * Execution
 * 1)
 ...
 * client (eg clisndrcv_host_pid_port_pubkey.c) to send 
...
#include "generate_pripubkey_func.c"
...
int main(int argc, char *argv[])
{
	...
	/* puts("bind done"); */
        ...
        if (getsockname(socket_desc, (struct sockaddr *)&server, &len) == -1)
         ...
         /* 
          * This code needs to generate a pubkey and send it
          * in this second message 6 Feb 2024
          * puts("pubkey:  ... still missing"); 
          * fflush(stdout); 
          */
